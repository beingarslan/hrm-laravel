            ...
            <div class="card-content">
                <div class="card">
                    ...
                    <div class="card-body py-2 my-25">
                        <form class="validate-form mt-2 pt-50" action="{{ route('inventory.categories.store')}}" method="post">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-1">
                                    ...
                                    <select class="form-control select2" name="parent_id">
                                        ...
                                        <option value="{{$obj->id}}" {{ (old("parent_id") == $obj->id ? "selected":"") }}>{{$obj->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-12 mb-1">
