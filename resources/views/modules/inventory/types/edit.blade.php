        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card">
                    ...
                    <form class="validate-form mt-2 pt-50" action="{{ route('inventory.types.update')}}" method="post">
                            @csrf
                            <!-- method -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-1">
                                    ...
                                    <textarea name="description" id="" class="form-control" cols="30" rows="10" placeholder="Description">{{$type->description}}</textarea>
                                </div>
