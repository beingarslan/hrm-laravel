...
@section('content')
<a class="btn btn-primary mb-2" href="/users/approvals/create">Create New Request</a>
<div class="row">
            ...
            <div class="card-content collapse show">
                <div class="card-body">
                    ...
                    <div class="list-group">
                        ...
                        <a href="/users/approvals/view/{{$approval->id}}" class="list-group-item list-group-item-action flex-column align-items-start">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="text-bold-600">{{$approval->title}}</h5>
