        ...
        <div class="card box-shadow-0">
            <div class="card-header">
                <h4 class="card-title">Menus
                    <a href="{{ route('interfaces.menus.create') }}" class="btn-min-width btn-primary mb-1" style="margin-left: 20px; font-size: 14px; padding: 5px;">Add New Menu Item </a>
                </h4>
