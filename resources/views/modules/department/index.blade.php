        ...
        <div class="card box-shadow-0">
            <div class="card-header">
                <h4 class="card-title">Departments
                    @can('add-master-departments')
                    <a href="{{ route('departments.create') }}" class="btn-min-width btn-primary mb-1" style="margin-left: 20px; font-size: 14px; padding: 5px;">Add New Department </a>
                    @endcan
                </h4>
