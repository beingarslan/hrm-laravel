            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Team Updation form</h4>
                    </div>
                    <div class="card-content">
                        <div class="card">
                            <div class="border-bottom-primary"> </div>
                            <div class="card-body py-2 my-25">
                                <form class="validate-form mt-2 pt-50" action="{{ route('teams.update')}}" method="post">
                                    @method('patch')
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-4 mb-1">
                                            ...
                                            <input readonly type="text" name="slug" value="{{ $team->slug }}" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-4 mb-1">
                                            ...
                                            <input readonly type="text" name="created_by" value="{{ $team->created_by ?? 'n/a'}} " class="form-control">
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-4 mb-1">
                                            ...
                                            <input readonly type="text" name="updated_by" value="{{ $team->updated_by ?? 'n/a'}} " class="form-control">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea rows = "10"  name="description" class="form-control">{{ $team->description }}</textarea>
                                        </div>
                                    </div>
